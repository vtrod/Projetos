...
if (isset($_POST['botaocadastro'])) {
    ...
    //$_POST['id_servico'],
        $_POST['nome_servico'],
        $_POST['duracao_servico'],
        $_POST['fx_agenda_servico'],
        $_POST['freq_recomendada_servico'],
        $_POST['preco'],
        $_POST['descricao_servico']
    );

    $servicoRepositorio = new ServicoRepositorio($pdo);
    $servicoRepositorio-> salvarServico($servico);

    header("Location: conservico2.php");

}

$servicoRepositorio = new ServicoRepositorio($pdo);
$servicos = $servicoRepositorio->exibirTodos();
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion fixed-top" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseAgenda" class="collapse" aria-labelledby="headingPets"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Opções:</h6>
                        <a class="collapse-item" href="./addagenda.php">Adicionar Agenda</a>
                        <a class="collapse-item" href="./conagenda.php">Consultar Agenda</a>
                      ...
                      <div class="card-header py-3">
                          ...
                          <div class="row">
                              ...
                              <div class="col-auto">
                                ...
                                <button type="button" class="btn btn-primary ml-1" title="Cadastrar" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                ...
                                                <!--Formulário para preenchimento do cadastro do serviço-->
                                                  ...
                                                  <div class="container mt-5 text-left">
                                                      <div class="row align-items-start">
                                                          <div class="col">
                                                              <div class="mb-3">
                                                                      <label for="exampleFormControlInput1" class="form-label" id="myList">*Nome:</label>
                                                                      <input type="text" class="form-control" id="exampleFormControlInput1" name="nome_servico" placeholder="Digite o Nome do Serviço">
                                                              </div>
                                                          </div>
                                                          <div class="col">
                                                              <div class="mb-3">
                                                                  <label for="exampleFormControlInput1" class="form-label" id="myList">*Duração Padrão:</label>
                                                                  <input type="text" class="form-control" id="exampleFormControlInput1" name="duracao_servico" placeholder="Digite a Duração do Serviço">
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
                                                      ...
                                                      <div class="row align-items-start">
                                                          <div class="col">
                                                              <div class="mb-3">
                                                                  ...
                                                                  <input type="text" class="form-control" id="exampleFormControlInput1" name="fx_agenda_servico" placeholder="Fluxo Agenda">
                                                              </div>
                                                          </div>
                                                          <div class="col">
                                                              <div class="mb-3">
                                                                  <label for="exampleFormControlInput1" class="form-label" >Frequência Recomendada:</label>
                                                                  <input type="text" class="form-control" id="exampleFormControlInput1" name="freq_recomendada_servico" placeholder="Frequência Recomendada">
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
                                                      ...
                                                      <div class="row align-items-start">
                                                          <div class="col">
                                                              <div class="mb-3">
                                                                  ...
                                                                  <textarea class="form-control" id="descreverservico" rows="5" name="descricao_servico" placeholder="Descreva aqui como funciona o serviço"></textarea>
                                                              </div>
                                                          </div>
                                                          ...
                                                          <div class="col">
                                                              <div class="mb-3">
                                                                  ...
                                                                  <textarea class="form-control" id="descreverservico" rows="1" name="preco" placeholder="Preço do serviço"></textarea>
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
   ...
   <!-- End of Service-->
                              ...
                              <div class="container mt-4 mb-5">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="ml-auto">
                                    <button type="submit" name="botaocadastro" class="btn btn-success btn-circle"><a href="conservico2.php" ><i class="fas fa-fw fa-chevron-down"></i></a></button>
  ...
  <table  id="myList" class="table table-bordered" width="100%" cellspacing="0">
      ...
      <tbody>
        ...
        <tr>
            <td id="myList"><a href="conservico2.php?id=<? $servico->getNomeServico()?>"><?=$servico->getNomeServico()?>               </a></td>
            <td id="myList"><a href="conservico2.php?id=<? $servico->getNomeServico()?>"><?=$servico->getDuracaoServico()?>            </a></td>
            <td id="myList"><a href="conservico2.php?id=<? $servico->getNomeServico()?>"><?=$servico->getFxAgendaServico()?>           </a></td>
            <td id="myList"><a href="conservico2.php?id=<? $servico->getNomeServico()?>"><?=$servico->getFreqRecomendadaServico()?>    </a></td>
            <td id="myList"><a href="conservico2.php?id=<? $servico->getNomeServico()?>"><?=$servico->getDescricaoServico()?>          </a></td>
            <td id="myList"><a href="conservico2.php?id=<? $servico->getNomeServico()?>"><?=$servico->getPreco()?>                     </a></td>
        </tr>
        </tbody>
      <?php endforeach; ?>
  </table>
...
<!-- End of Footer -->
    ...
    <!-- Search button to find on table -->
    <script>
